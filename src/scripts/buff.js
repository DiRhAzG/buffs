    ...
    if (!foundBuff) {
        ...
        if (expireTime != undefined) {
            if (
                ...
                // || (selectedBuff == "bookBuff" || selectedBuff == "excaliburBuff" || selectedBuff == "ritualShardBuff" || selectedBuff == "darknessBuff" || selectedBuff == "penanceBuff") // Want to just keep tracking if these are found or not
            ) {
