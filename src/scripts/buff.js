...
let imageData = [
    ...
    // Jas
    { id: 15, name: "bookBuff", imgData: "" },
    // Wen
    ...
    if (!foundBuff) {
        ...
        if (expireTime != undefined) {
            if (
                ...
                (selectedBuff != "vulnBuff" && selectedBuff == "smokeCloudBuff") // Want to just keep tracking if these are found or not
            ) {
